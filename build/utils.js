...
// 多页面相关
var glob = require('glob') // 通过file pattern march语法批量获取文件
var HtmlWebpackPlugin = require('html-webpack-plugin') // 页面模板
var PROJECT_PATH = path.resolve(__dirname, '../src/projects') // 取得projects的页面路径
...
exports.entries = function() {
    var entryFiles = glob.sync(PROJECT_PATH + '/*/*.js')
    var map = {}
...
exports.htmlPlugin = function() {
    let entryHtml = glob.sync(PROJECT_PATH + '/*/*.html')
    let arr = []
